...
public class TripController {
    ...
    @GetMapping("/search")
    @Cacheable(value = "flightSearch", key = "T(com.example.FlightBookingSystem.helpers.KeyGenerator).generateKeyForFlightSearch(#source, #destination, #date, #numberOfSeats, #seatType,#airline_name)")
